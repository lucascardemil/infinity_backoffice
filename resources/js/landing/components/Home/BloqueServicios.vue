<template>
    <div class="container-fluid bg-light pt-5 pb-5">
        <div class="container">
            <div class="row pb-5">
                <div class="col-auto">
                    <p class="texto-titulo">NUESTROS SERVICIOS</p>
                    <h3>Nos ajustamos a tus necesidades</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 gap-3">
                    ...
                    <p class="text-muted fs-5">Arrendamos tu propiedad al arrendatario ideal, firmas tus contratos de
                        arriendo 100% online y
                        entregamos un informe completo del proceso al terminar la transacción.</p>
                </div>
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <p class="text-muted fs-5">Ofrecemos tu propiedad, tanto a personas que buscan su primer hogar, como
                        a inversionistas. Te apoyamos en todo el proceso, solo te encargas de firmar.</p>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="mb-4">
